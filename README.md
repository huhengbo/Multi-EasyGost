...
> 项目地址及帮助文档:  
> https://github.com/huhengbo/Multi-EasyGost
***
## 脚本

* 启动脚本  
  `wget --no-check-certificate -O gost.sh https://raw.githubusercontent.com/huhengbo/Multi-EasyGost/v2/gost.sh && chmod +x gost.sh && ./gost.sh`  
